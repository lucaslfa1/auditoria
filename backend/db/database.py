...
def init_db():
    ...
    try:
        ...
        default_configs = [
            ...
            ('automacao_cobertura_backfill_ativa', 'true', 'Ativa busca direcionada de ligacoes para operadores abaixo da cobertura'),
            ('automacao_cobertura_backfill_lookback_dias', '7', 'Dias retroativos da busca direcionada por operador abaixo da cobertura'),
            ('automacao_cobertura_backfill_max_operadores', '3', 'Maximo de operadores abaixo da cobertura buscados por ciclo'),
