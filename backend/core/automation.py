...
# Storage de áudio classificado: extraído para core.classified_audio_storage
# (concern de filesystem/mídia, fora do loop de auditoria). Reexportado p/ compat:
# callers e patches usam core.automation.<fn> (e telefonia/huawei_sync importam daqui).
from core.classified_audio_storage import (  # noqa: E402,F401
    load_classified_audio,
    store_classified_audio,
    open_classified_audio_stream,
    cleanup_classified_audio_storage,
    get_classified_audio_storage_root,
)

# Configuração/tuning da esteira: extraído para core/automation_config.py
# (v1.3.170); reexportado p/ compat (callers internos, routers/audit e
# routers/system importam _get_monthly_audit_quota, e patches em core.automation.<nome>).
from core.automation_config import (  # noqa: E402,F401
    DEFAULT_AUTOMATION_AUDIT_TARGET_COUNT,
    DEFAULT_AUTOMATION_EXPECTED_AUDIT_ITEM_SECONDS,
    _get_automation_item_timeout_seconds,
    _coerce_positive_int,
    _read_config_value_with_fallback,
    _get_automation_audit_target_count,
    ...
    _discard_blocked_operator_enabled,
    _audit_ignore_monthly_cap_enabled,
    _discard_missing_sector_enabled,
    _discard_no_criteria_enabled,
    _discard_non_telephony_enabled,
